...
Gem::Specification.new do |spec|
  spec.name          = "chat_sdk-state-mysql"
  spec.version       = ChatSDK::VERSION
  spec.authors       = ["Quentin Rousseau"]
  spec.email         = ["quentin@rootly.com"]
  spec.summary       = "MySQL state backend for ChatSDK"
  spec.description   = "MySQL-backed conversation state storage for the ChatSDK framework with auto-migration and JSON storage"
