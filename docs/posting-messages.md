...
Cards are automatically rendered as Block Kit (Slack), Adaptive Cards (Teams), or Card v2 (Google Chat). See [Cards](cards.md) for the full DSL reference.
...
See [Ephemeral Messages](ephemeral-messages.md).
...
The stream posts a placeholder message and edits it as chunks arrive, with built-in throttling. See [Streaming](streaming.md).
