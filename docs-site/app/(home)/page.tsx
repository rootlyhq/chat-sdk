...
const platforms = [
  {
    name: 'Slack', color: '#4A154B', href: '/docs/adapters/slack',
  ...
  {
    name: 'Teams', color: '#6264A7', href: '/docs/adapters/teams',
  ...
  {
    name: 'Google Chat', color: '#00AC47', href: '/docs/adapters/gchat',
  ...
  {
    name: 'Mattermost', color: '#0058CC', href: '/docs/adapters/mattermost',
  ...
  {
    name: 'Discord', color: '#5865F2', href: '/docs/adapters/discord',
  ...
  {
    name: 'Telegram', color: '#26A5E4', href: '/docs/adapters/telegram',
          ...
          <div className="flex flex-wrap gap-3 justify-center max-w-2xl mx-auto">
            {platforms.map((p) => (
              <Link
                key={p.name}
                href={p.href}
                className="flex items-center gap-2.5 px-4 py-2 rounded-full bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-sm hover:border-red-500/30 transition-colors"
              >
            ...
            <Link
              href="/adapters"
              className="flex items-center gap-2.5 px-4 py-2 rounded-full bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-sm text-gray-400 hover:border-red-500/30 hover:text-gray-600 dark:hover:text-gray-300 transition-colors"
            >
