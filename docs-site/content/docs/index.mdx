...
ChatSDK Ruby is a unified SDK for building chat bots that work across Slack, Microsoft Teams, Google Chat, Mattermost, and any other platform you write an adapter for. Inspired by [Vercel's Chat SDK](https://chat-sdk.dev), redesigned with idiomatic Ruby patterns.
