...
description: Fetch previous messages from threads and channels for building context-aware bots.
---
...
| Mattermost | Yes | Uses `get_posts_for_channel` |
| Discord | Yes | Uses `get_channel_messages` |
