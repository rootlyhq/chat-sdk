...
| Edit | yes | yes | yes | yes | yes | yes | no | no | no | no |
| Delete | yes | yes | yes | yes | yes | yes | no | no | no | no |
| Ephemeral | yes | no | yes | yes | no | no | no | no | no | no |
| Reactions | yes | yes | yes | yes | yes | yes | no | no | yes | yes |
| Files | yes | yes | no | yes | yes | yes | no | yes | yes | no |
| Modals | yes | no | no | no | no | no | no | no | no | no |
| Streaming | yes | yes | yes | yes | yes | yes | no | no | no | no |
| DMs | yes | yes | yes | yes | yes | yes | yes | yes | yes | yes |
| History | yes | yes | yes | yes | yes | no | no | no | no | no |
| Typing | yes | no | no | yes | no | yes | no | yes | no | no |
