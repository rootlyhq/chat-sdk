---
title: Streaming
description: Post placeholder messages and update them incrementally with built-in throttling for AI-style token-by-token responses.
---
