...
Gem::Specification.new do |spec|
  spec.name          = "chat_sdk-messenger"
  spec.version       = ChatSDK::VERSION
  spec.authors       = ["Quentin Rousseau"]
  spec.email         = ["quentin@rootly.com"]
  spec.summary       = "Facebook Messenger adapter for ChatSDK"
  spec.description   = "Facebook Messenger adapter for the ChatSDK framework with HMAC-SHA256 verification and template rendering"
